...
def get_arguments():
    ...
    parser.add_argument('--password', default='motorola', help='Admin password')
    parser.add_argument('action', default='test', choices=['test', 'summary', 'details', 'events', 'reboot'])
    ...
    if args.action == 'test':
        for command in system.get_commands(hnap_session):
            if command.read_only:
                ...
                system.do_command(hnap_session, command)
